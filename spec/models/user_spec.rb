...
describe User do
	...
	before do
		@user = User.new(name: "Matt Redman", email: "mattredman@example.com", password: "foobar", password_confirmation: "foobar") 
	end
	...
	describe "accessible attributes" do 
		it "should_not allow access to admin" do 
			expect do 
				User.new(admin: true)
	...
	describe "when email format is not valid" do
		it "should be invalid" do
			adresses = %w[user@foo,com user_at_foo.org example.foo@foo. foo@bar_baz.com foo@bar+baz.com]
	...
	describe "when email format is valid" do
		it "should be valid" do
			adresses = %w[user.foo@foo.COM A_US-ER@f.b.org frst.lst@foo.jp a+b@baz.cn]
	...
	describe "return value od authentification method" do
		before { @user.save }
